...
@[target] theorem le_def [LE β] (x y : α) :
    letI := by sorry
...
@[target] theorem lt_def [LT β] (x y : α) :
    letI := by sorry
...
@[target] theorem min_def [Min β] (x y : α) :
    letI := by sorry
...
@[target] theorem max_def [Max β] (x y : α) :
    letI := by sorry


@[target] theorem apply_max [Max β] (x y : α) :
    letI := e.max
    e (x ⊔ y) = e x ⊔ e y := by
  sorry
...
@[target] theorem ltWellOrder_type [LtWellOrder β] :
    letI := e.ltWellOrder
...
@[target] theorem ltWellOrder_typein [i : LtWellOrder β] (x : α) :
...
@[target] theorem apply_add [Add β] (x y : α) :
    letI := e.add
    e (x + y) = e x + e y := by
  sorry


@[target] theorem apply_sub [Sub β] (x y : α) :
    letI := e.sub
    e (x - y) = e x - e y := by
  sorry


@[target] theorem apply_zero [Zero β] :
    letI := e.zero
    e 0 = 0 := by
  sorry
